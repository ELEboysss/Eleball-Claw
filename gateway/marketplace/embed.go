...
// FS 官方模块目录（stt / search-web / firecrawl / agent-reach / skill-maker / mcp-hello / mcp-stdio-echo），含 module.json、
...
//
//go:embed all:stt all:search-web all:firecrawl all:agent-reach all:skill-maker all:mcp-hello all:mcp-stdio-echo
var FS embed.FS
